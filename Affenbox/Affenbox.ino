...
void setup()
{
  ...
  Serial.println(F("Affenbox v2.12 by Marco Schulz"));
...
#if defined supportsFolderCount
      int16_t folderCount = mp3.getTotalFolderCount();
      tempCard.nfcFolderSettings.folder = voiceMenu(folderCount, 301, 0, true);
#else
...
#if defined supportsFolderCount
  int16_t folderCount = mp3.getTotalFolderCount();
  theFolder->folder = voiceMenu(folderCount, 301, 0, true, 0, 0, true);
#else
